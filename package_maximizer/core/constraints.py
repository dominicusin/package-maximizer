...
class VersionConstraint:
    ...
    def satisfied_by(self, version: str) -> bool:
        ...
        if self.operator == "==":
            ...
            return (
                target_version >= constraint_version
                and target_version < self._get_next_major(constraint_version)
            )
        else:
            ...
            if op in constraint_str:
                ...
                if len(parts) == 2:
                    return VersionConstraint(
                        package="", operator=op, version=parts[1].strip()
                    )
        ...
        if op_found and op_pos > 0:
            ...
            return DependencyConstraint(
                ...
                version_constraint=VersionConstraint(
                    package="", operator=op_found, version=version_part
                ),
            )
