...
class BenchmarkRunner:
    ...
    def print_report(self, report: BenchmarkReport) -> None:
        ...
        for result in report.results:
            ...
            print(f"{result.solver_name:<15} {result.avg_time:>12.4f} {result.min_time:>12.4f} {result.max_time:>12.4f} {result.selected_count:>10} {status:>10}")
    ...
    def export_report(report: BenchmarkReport, format: str = 'json') -> str:
        ...
        if format == 'json':
            ...
            lines = ["solver_name,package_count,conflict_count,avg_time,min_time,max_time,selected_count,success"]
            for r in report.results:
